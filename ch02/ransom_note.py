...
# values of  (the number of words in the magazine) and  (the number of words in
# the ransom note).
# The second line contains  space-separated strings denoting the words present
# in the magazine.
# The third line contains  space-separated strings denoting the words present
# in the ransom note.
# Constraints
#
# .
